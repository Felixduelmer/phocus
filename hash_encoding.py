...
class HashEmbedder(nn.Module):
    def __init__(self, bounding_box, n_levels=12, n_features_per_level=1,\
                log2_hashmap_size=19, base_resolution=256, finest_resolution=512):
        ...
        for i in range(n_levels):
            print("num parameters:", sum(p.numel() for p in self.embeddings[i].parameters() if p.requires_grad))
